...
kotlin {
    ...
    sourceSets.commonTest.dependencies {
        ...
        // ani-mpp-lib-targets). Declaring `kotlin("test")` here triggers JVM variant inference to
        // kotlin-test-junit (JUnit 4), which collides with the JUnit 5 variant the
        // de.mannodermaus.android-junit5 plugin pulls onto androidDeviceTestCompileClasspath —
        // same capability, two modules.
    }
