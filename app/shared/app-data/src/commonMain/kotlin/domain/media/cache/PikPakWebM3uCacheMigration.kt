...
class PikPakWebM3uCacheMigration(
    ...
    suspend fun migrate() {
        ...
        // commit rather than after. Cleaning after would strand them: once the records are gone they are
        // no longer candidates, and no later run could find the files again. Re-running before the commit
        // is harmless because a second pass finds the HTTP row already gone and does nothing.
